...
<head>
  ...
  <link rel="stylesheet" href="{{asset('assets/vendor/animated/animate.css')}}">
...
<body>
  ...
  <header>
    ...
    <nav class="navbar navbar-expand-lg navbar-light shadow-sm">
      <div class="container">
        <a class="navbar-brand" href="#"><span class="text-primary">Klinik</span>-Alisah</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupport">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
                <a class="nav-link" href="blog.html">Dokter</a>
              </li>
            <li class="nav-item">
              <a class="nav-link" href="about.html">Fasilitas</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="doctors.html">Artikel</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="doctors.html">Kontak</a>
              </li>
          </ul>
        </div> <!-- .navbar-collapse -->
      </div> <!-- .container -->
